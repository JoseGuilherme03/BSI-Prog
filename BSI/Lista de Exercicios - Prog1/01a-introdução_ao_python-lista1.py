...
def preco_com_desconto(preco_original, percentual_desconto):
    ...
    """
    reajuste = preco_original - (preco_original * percentual_desconto) / 100
    return round(reajuste, 2)
...
def dias_perdidos_por_fumar(cigarros_fumados_por_dia, anos_fumando):
    ...
    total_cigarros_fumados = (cigarros_fumados_por_dia * 365) * anos_fumando
    dias_perdidos = ((total_cigarros_fumados * 10) / 60) / 24
    return floor(dias_perdidos)
