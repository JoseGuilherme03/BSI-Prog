...
def jardas_para_metros(jardas):
    ...
    """
    totmetros = jardas * 0.9144
    return round(totmetros,2)
...
def acesso_4G(qt_alunos_total, qt_alunos_4G):
    ...
    A sua pesquisa deverá apresentar o percentual de alunos da sua escola que possuem acesso ao 4G.
    Para isso, elabore um algoritmo que leia o número total de alunos da sua escola e o número de alunos que possuem acesso a redes 4G, por fim, com base nestes dados, escreva o percentual de alunos com acesso ao 4G.
    Por exemplo, em uma escola com 2000 alunos, apenas 700 alunos possuem acesso à Internet, o que equivale a 40% destes 2000 alunos.
    ...
    """
    porcentagem = (qt_alunos_4G * 100) / qt_alunos_total
...
def lan_house(valor_15_minutos, qt_minutos_uso):
    """
    Elaborar um programa para uma lan house. O programa deve ler o valor para cada 15 minutos de uso de um computador e o tempo do cliente em minutos. Informe o valor a ser pago pelo cliente, sabendo que as frações extras de 15 minutos devem ser cobradas de forma integral.
